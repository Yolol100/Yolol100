...
Most client and production work is private. The six projects below are selected public examples that show how I solve WordPress, WooCommerce, performance, structured content and website-quality problems.
...
- **WordPress & WooCommerce:** custom plugins, integrations, Elementor, Gutenberg, ACF, content workflows, maintenance and migrations.
- **PHP & WordPress engineering:** capabilities, nonces, REST/admin flows, background processing, import/export, recovery paths and compatibility work.
- **UX-minded development:** responsive interfaces, clear information structure, accessibility-aware implementation and conversion-focused layouts.
...
| --- | --- | --- |
| [ACF Page Text Manager](https://github.com/Yolol100/ACF-Text-Manager) | Brings page/post content, ACF values, SEO metadata and image text into one controlled editing workflow. | WordPress/PHP, ACF, Yoast/Rank Math, CSV/XLSX, admin UX, safe imports |
...
**Think first → Structure clearly → Build carefully → Improve continuously**

- Clarify the goal, users and content before choosing the implementation.
- Keep changes understandable, reviewable and as small as the task allows.
...
- Keep credentials, customer data and private runtime state out of public repositories.
- Prefer maintainable WordPress solutions that editors and development teams can continue to support.
...
I am available for **fully remote WordPress roles**, contract work and selected freelance projects involving WordPress, WooCommerce, Elementor, ACF, custom plugins, UX, website performance, technical SEO or quality automation.
